...
def send_to_remote(filepath, remote_host, username, key_file=None, remote_path="."):
...
if __name__ == '__main__':
    ...
    send_to_remote(args.file, args.remote_host, args.username, args.key_path, args.remote_path)
